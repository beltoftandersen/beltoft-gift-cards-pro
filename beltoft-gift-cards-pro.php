...
add_action( 'plugins_loaded', function () {
	...
	if ( version_compare( BGCW_VERSION, '1.5.0', '<' ) ) {
		add_action( 'admin_notices', function () {
			echo '<div class="notice notice-warning"><p>';
			esc_html_e( 'Beltoft Gift Cards for WooCommerce - Pro requires version 1.5.0 or higher of the free plugin. Please update.', 'beltoft-gift-cards-pro' );
			echo '</p></div>';
		} );
		return;
	}
