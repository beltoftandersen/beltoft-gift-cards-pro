...
<div style="text-align: center; margin: 20px 0 10px;">
	<img
		src="<?php echo esc_url( WCGC_PRO_URL . 'assets/images/themes/birthday.png' ); ?>"
		alt="<?php esc_attr_e( 'Birthday', 'smart-gift-cards-for-woocommerce-pro' ); ?>"
		style="max-width: 100%; height: auto; display: inline-block;"
	/>
	<h2 style="color: #e91e63; font-size: 24px; margin: 15px 0 5px;">
		<?php
		echo esc_html(
...
<?php if ( ! empty( $gift_card->message ) ) : ?>
	<p style="font-style: italic; color: #555; padding: 10px 20px; border-left: 3px solid #e91e63; margin: 15px 0;">
...
<div style="text-align: center; margin: 30px 0;">
	...
	<div style="background: #fce4ec; padding: 15px 25px; display: inline-block; border-radius: 6px; margin: 10px 0; border: 2px dashed #e91e63;">
		<span style="font-family: monospace; font-size: 20px; letter-spacing: 3px; font-weight: bold; color: #e91e63;">
...
<p style="text-align: center; margin: 25px 0;">
	<a href="<?php echo esc_url( add_query_arg( 'wcgc_apply', rawurlencode( $gift_card->code ), wc_get_page_permalink( 'shop' ) ) ); ?>"
	   style="display: inline-block; background: #e91e63; color: #fff; padding: 12px 30px; text-decoration: none; border-radius: 4px; font-weight: bold;">
