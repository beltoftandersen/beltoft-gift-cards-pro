...
<div style="text-align: center; margin: 20px 0 10px;">
	<img
		src="<?php echo esc_url( WCGC_PRO_URL . 'assets/images/themes/classic.png' ); ?>"
		alt="<?php esc_attr_e( 'Classic', 'smart-gift-cards-for-woocommerce-pro' ); ?>"
		style="max-width: 100%; height: auto; display: inline-block;"
	/>
	<h2 style="color: #7f54b3; font-size: 24px; margin: 15px 0 5px;">
		<?php esc_html_e( "You've received a gift card!", 'smart-gift-cards-for-woocommerce-pro' ); ?>
	</h2>
</div>
...
<?php if ( ! empty( $gift_card->message ) ) : ?>
	<p style="font-style: italic; color: #555; padding: 10px 20px; border-left: 3px solid #7f54b3; margin: 15px 0;">
...
<div style="text-align: center; margin: 30px 0;">
	...
	<div style="background: #f5f5f5; padding: 15px 25px; display: inline-block; border-radius: 6px; margin: 10px 0; border: 2px dashed #7f54b3;">
		<span style="font-family: monospace; font-size: 20px; letter-spacing: 3px; font-weight: bold; color: #7f54b3;">
...
<p style="text-align: center; margin: 25px 0;">
	<a href="<?php echo esc_url( add_query_arg( 'wcgc_apply', rawurlencode( $gift_card->code ), wc_get_page_permalink( 'shop' ) ) ); ?>"
	   style="display: inline-block; background: #7f54b3; color: #fff; padding: 12px 30px; text-decoration: none; border-radius: 4px; font-weight: bold;">
