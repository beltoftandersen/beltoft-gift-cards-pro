...
printf(
	...
	esc_html__( 'Amount: %s', 'beltoft-gift-cards-pro' ),
...
printf(
	...
	esc_html__( 'Code: %s', 'beltoft-gift-cards-pro' ),
...
printf(
	...
	esc_html__( 'Shop now: %s', 'beltoft-gift-cards-pro' ),
	esc_url( add_query_arg( 'bgcw_apply', rawurlencode( $gift_card->code ), wc_get_page_permalink( 'shop' ) ) )
);
echo "\n\n";

esc_html_e( 'Click the link above to apply your gift card automatically, or enter the code at checkout in the coupon/gift card field.', 'beltoft-gift-cards-pro' );
echo "\n\n";
