...
printf(
	...
	esc_html__( 'Amount: %s', 'smart-gift-cards-for-woocommerce-pro' ),
...
printf(
	...
	esc_html__( 'Code: %s', 'smart-gift-cards-for-woocommerce-pro' ),
...
printf(
	...
	esc_html__( 'Shop now: %s', 'smart-gift-cards-for-woocommerce-pro' ),
	esc_url( add_query_arg( 'wcgc_apply', rawurlencode( $gift_card->code ), wc_get_page_permalink( 'shop' ) ) )
);
echo "\n\n";

esc_html_e( 'Click the link above to apply your gift card automatically, or enter the code at checkout in the coupon/gift card field.', 'smart-gift-cards-for-woocommerce-pro' );
echo "\n\n";
