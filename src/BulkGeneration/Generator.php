...
class Generator {
	...
	public static function ajax_bulk_generate() {
		...
		if ( $quantity < 1 || $quantity > 500 ) {
			wp_send_json_error(
				[ 'message' => __( 'Quantity must be between 1 and 500.', 'beltoft-gift-cards-pro' ) ]
			);
		}
		...
		if ( $amount <= 0 ) {
			wp_send_json_error(
				[ 'message' => __( 'Amount must be greater than zero.', 'beltoft-gift-cards-pro' ) ]
			);
		}
		...
		for ( $i = 0; $i < $quantity; $i++ ) {
			...
			if ( $gc_id ) {
				TransactionRepository::insert( [
					...
					'note'          => __( 'Bulk generated by admin', 'beltoft-gift-cards-pro' ),
				] );
		...
		wp_send_json_success( [
			...
			'message' => sprintf( __( '%d gift card(s) generated successfully.', 'beltoft-gift-cards-pro' ), $created ),
		] );
	}
